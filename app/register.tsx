...
export default function RegisterScreen() {
  ...
  // removed intentionally — for the same reasons as login.tsx.
  //
  // AuthGate in _layout.tsx now owns all post-auth routing. After a
  // successful signUp() that immediately signs the user in (which
  // Supabase does when email confirmation is disabled), the SIGNED_IN
  // event flows through AuthContext → AuthGate, which routes the user
  // to the correct home screen based on their role. No screen-level
